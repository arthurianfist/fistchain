...
replace github.com/cosmos/cosmos-sdk/simapp => cosmossdk.io/simapp v1.2.3

require cosmossdk.io/store v0.1.0-alpha.1.0.20230328185921-37ba88872dbc
...
require (
	...
	google.golang.orgq/grpc v1.54.0 // indirect
